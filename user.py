...
def get_list(db, order='none', limit=None, page=None):
    ...
    sql_base = 'select {}.id, {}.name, mobile_team_id, mobile_team.name as mobile_team, login, avatar ' \
               'from {} ' \
               'left join mobile_team on {}.mobile_team_id = mobile_team.id '.format(table_name, table_name, table_name,
                                                                                     table_name)
...
def get_item(db, session_key, user_id):
    ...
    sql = 'select user.id, user.name, mobile_team_id, mobile_team.name as mobile_team, login, avatar ' \
          'from user ' \
